...
public class Lab10 {
    ...
    public static int specialEars(int n) {
        if (n == 0) return 0;
        if (n % 2 == 1) { // odd‑numbered rabbit
            return 2 + specialEars(n - 1);
        }
        return 3 + specialEars(n - 1); // even‑numbered rabbit
    }
    ...
    public static String replaceChar(String str) {
        ...
        return first + replaceChar(str.substring(1));
    }
    ...
    public static String removeChar(String str) {
        ...
        return first + removeChar(str.substring(1));
    }
